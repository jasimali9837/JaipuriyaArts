...
export const Navbar = () => {
  ...
  return (
    <>
      <section className="    hidden  min-h-[10vh]  justify-center sm:flex   items-center">
        <h2 className="  text-[20px] sm:text-[25px] xl:text-[30px]   font-semibold">
          {" "}
          Jaipuria Arts{" "}
        </h2>
      </section>
    ...
    xl:text-[20px] text-[15px] items-center bg-[#7E1518] h-[70px]   "
      >
        ...
        <section className="  sm:hidden    min-h-[10vh]  justify-center flex    items-center">
          <h2 className="  text-[20px] sm:text-[25px] xl:text-[30px]   font-semibold">
            {" "}
            Jaipuria Arts{" "}
          </h2>
